    ...
    >
      ...
      >
        ...
        <div className="mb-5">
          ...
          <div className="relative">
            <input
              ...
              onKeyDown={(e) => e.key === 'Enter' && handleSubmit()}
              className="w-full rounded-lg border px-4 py-2.5 text-sm outline-none transition-all pr-4 pl-10"
        ...
        <button
          ...
          className="w-full rounded-lg py-2.5 text-sm font-semibold flex items-center justify-center gap-3 border transition-colors hover:bg-gray-50"
          style={{
